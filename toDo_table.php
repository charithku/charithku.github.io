                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                             ...
                             <thead>
								...
								include("config.php");
								//session_start();
				                $supempno=$_SESSION['login_user'];
								$sql = "SELECT * FROM request JOIN user ON request.empNo=user.EmpNo WHERE status=1 AND supervisor=$supempno";
								...
								while($row = mysqli_fetch_assoc($result)) {
								  //echo "<option value='".$row[itemcode]."'>".$row[itemcode]."</option>";
									echo "<tr class=\"\">";
										...
										//echo "<td><button onclick='viewItem(".$row["requestID"].")'>View</button>";
										echo "<td><button class='btn-info registerbtn' onclick='viewItem(".$row["requestID"].")'>View</button> <a>  </a> 
										<button class='btn-success' onclick='approve(".$row["requestID"].")'>Approve</button>  <a></a>
										<button class='btn-danger' onclick='reject(".$row["requestID"].")'>Reject</button></td>";
										
										//echo "<td><a class=\"edit\" href=\"./approval.php\">Edit</a></td>";
...
<script>
 ...
 <script type="text/javascript">
    ...
    function viewItem(requestId) {
      var form = document.createElement("form");
      form.setAttribute("method", "post");
      form.setAttribute("action", "approval.php");
